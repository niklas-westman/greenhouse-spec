...
docs/ is documentation and repo knowledge surface. It has no documented coverage and covered validation.

## Purpose

Documentation and repo knowledge surface.
...
- status: covered
- routes: docs/**
- commands: pnpm test:templates, pnpm typecheck
- manual checks: none
