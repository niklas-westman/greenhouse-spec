...
export function formatUpdateReport(report: UpdateReport): string {
  const lines = [
    ...
    "",
    "Greenhouse keeps the consumer repo contract clear as Guide / Check / Remember:",
    "",
    "- Guide: refreshed generated repo intelligence for task context.",
    "- Check: refreshed command indexes, risk indexes, and validation proposals.",
    "- Remember: preserved repo-local evidence/reports and refreshed managed helpers.",
    "",
    "Authored roots remain protected; update only refreshes generated intelligence, managed install files, and missing purpose docs.",
    "",
