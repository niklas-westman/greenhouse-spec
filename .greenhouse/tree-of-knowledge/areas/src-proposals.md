...
src/proposals/ is application or repository source area. It has no documented coverage and covered validation.
...
- status: covered
- routes: src/proposals/**
- commands: pnpm test:proposals, pnpm typecheck
- manual checks: none
