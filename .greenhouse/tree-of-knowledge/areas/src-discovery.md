...
src/discovery/ is application or repository source area. It has 1 documented coverage link and covered validation.
...
- docs/architecture.md (warning) - Architecture docs describe discovery as the source of generated repo intelligence.

## Validation

- status: covered
- routes: src/discovery/**
- commands: pnpm test:discovery, pnpm typecheck
- manual checks: none
