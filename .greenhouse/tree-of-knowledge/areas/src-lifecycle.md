...
src/lifecycle/ is application or repository source area. It has no documented coverage and covered validation.
...
- status: covered
- routes: src/lifecycle/**
- commands: pnpm test:lifecycle, pnpm typecheck
- manual checks: none
