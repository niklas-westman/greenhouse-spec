...
src/verify/ is application or repository source area. It has 1 documented coverage link and covered validation.
...
- docs/validation-routing.md (guarded) - Verify output and routing behavior are documented here.

## Validation

- status: covered
- routes: src/verify/**
- commands: pnpm test:validation, pnpm typecheck
- manual checks: none
